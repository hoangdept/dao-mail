...
def checkhotmail():
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m➻❥ |\033[1;37mTHẤY\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m➻❥ |\033[1;37mTHẤY\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m➻❥ |\033[1;37mTHẤY\033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m➻❥ |\033[1;37mTHẤY\033[1;31m|Email Live| " + yid + "@yahoo.com")
...
def checkvalid():
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" \033[1;32m➻❥ |\033[1;37mTHẤY\033[1;32m| Có Liên Kết |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" \033[1;31m➻❥ |\033[1;37mTHẤY\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
